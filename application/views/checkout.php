            ...
            <div class="navbar-collapse collapse" id="bdNavbar">
                <ul class="navbar-nav flex-row flex-wrap ms-md-auto justify-content-center">
                    ...
                    <li class="nav-item col-3 col-md-auto mx-1 text-center dropdown">
                        <!-- NAMA --> <a class="nav-link" href="" title="Akun"><?= $data['username']; ?></a>
                    </li>
                    <li class="nav-item col-11 col-md-auto mx-1 d-block d-md-none">
                        <hr class="text-white">
                    </li>
    ...
    <div class="container-fluid mt-5">
        <div class="row row-cols-1 row-cols-md-2 row-cols-lg-2 justify-content-center">
            ...
            <div class="col-lg-8 col-auto text-md-end text-center text-white" id="profil">
                <h1 class="my-4">Barang yang dibeli</h1>
                <hr style="border: 3px solid white; opacity: 1; background-color: white;">
                <div class="container-fluid py-5">
                    <div class="row row-cols-md-3 gx-4 row-cols-1 mx-2 my-2 justify-content-start">
                        <div class="col-md-2 col-10 mx-3 text-center">
                            <img src="Uploads/<?= $data['logo']; ?>" id="logo" title="<?= $data['logo']; ?>" width="150px" height="150px">
                        </div>
                ...
                <div class="container-fluid py-5">
                    <div class="row row-cols-md-3 gx-4 row-cols-1 mx-2 my-2 justify-content-start">
                        <div class="col-md-4 col-10 mx-3 text-center" style="margin-right: 30px;">
                            <img src="barang/<?= $data['foto_barang']; ?>" style="width:300px; height:auto; margin-right: 30px;" title="<?= $data['nama_barang']; ?>">
                        </div>
                        <div class="col-md-6 col-10 mx-3 text-start">
                            <h3 class="mb-4" style="margin-left: 40px;"><?= $data['nama_barang']; ?></h3>
                            <h5 class="mb-4" style="margin-left: 40px;">Harga Rp <?= $data['harga']; ?></h5>
                            <div class="main">
                                <P style="margin-left: 40px;">Jumlah</P>
                                <form action="last" method="post" style="margin-left: 40px;">
                                    <input class="counter" type="number" value='0' id="jumlah" name="jumlah">
                            </div>
                            <label style="margin-left: 40px;" class='muted'>(or type any numeric value)</label>
                            <script>
                ...
                <hr style="border: 3px solid white; opacity: 1; background-color: white;">
                <h1 class="my-4">Pengiriman dan Pembayaran</h1>
                <hr style="border: 1px solid white; opacity: 1; background-color: white;">
                <div class="container-fluid py-5">
                    <div class="row row-cols-md-3 gx-4 row-cols-1 mx-2 my-2 justify-content-evenly">
                        <div class="col-md-9 col-10 mx-3 text-start">
                            <h3>Rumah - <?php echo $data['Desa']; ?></h3>
                            <p><?php echo $data['Street'] . ",";
                                echo $data['Provinsi'] . ",";
                                echo $data['Kabupaten'] . ",";
                                echo $data['Kecamatan'] . ",";
                                echo $data['postcode']; ?></p>
                        </div>
                        <div class="col-md-2 col-10 mx-3 text-center">
                            <h4><a href="" class="link" data-toggle="modal" data-target="#change_data_Modal">Edit</a></h4>
                        </div>
                    </div>
                </div>
                <hr class="" style="border: 3px solid white; opacity: 1; background-color: white;">
                <div class="info">
                    <h2 class="text-start">Pilih Pengiriman</h2><br>
                </div>
                <select class="form-select w-25" aria-label=".form-select-sm">
                    <option selected>Pilih Menu Pengiriman</option>
                    <option value="1">Reguler: 4-5 hari</option>
                    <option value="2">Ekspress: 2-3 hari</option>
                    <option value="3">Kilat: 1 hari</option>
                </select>
                <hr class="" style="border: 3px solid white; opacity: 1; background-color: white;">
                <div class="info">
                    <h2 class="text-start">Pilih Pembayaran</h2><br>
                </div>
                <select class="form-select w-25" aria-label=".form-select-sm">
                ...
                <hr class="" style="border: 3px solid white; opacity: 1; background-color: white;">
                <!-- 3 -->
                <div class="col-lg-8 col-sm-auto" style="color:white; text-align: justify; background-color:rgba(0, 0, 0, 0.7); margin:auto;">
                    <div class="info">
                        <h1 style="font-size:36px;">Ringkasan Belanja</h1><br>
                        <h2 style="font-size:12px">Total Harga : Rp. <?= $data['harga']; ?></h2>
                        <h2 style="font-size:12px">Total Ongkos Kirim : Rp. 60.000</h3>
                            <h2 style="font-size:12px">Biaya Layanan : Rp. 3.000</h3>
                    </div>
                    <hr class="" style="border: 3px solid white; opacity: 1; background-color: white;">
                    <div class="info">
                        <h2 style="font-size:24px;">Total Tagihan : Rp. 1.313.000</h1><br><br>
                    </div>
                </div>
                <br><br>
                <button class="button btn-danger" type="button">Kembali</button>
                <a>
                    <form action="last">
                        <input type="submit" class="btn-primary" style="border-radius: 10px; background-color: rgba(0, 0, 0, 0.8); color: white;"></input>
                </a><br><br><br>
                </form>
            </div>
        ...
        <!-- UBAH ALAMAT -->
        <div style="z-index: 9999;" class="modal fade" id="change_data_Modal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                    ...
                    <form class="form-signin" method="post">
                        <div class="modal-body justify-content-center">
                            <div class="form-floating mb-2 mx-auto">
                                <input type="text" class="form-control" id="label" name="label" placeholder="Label alamat" value="Rumah" required>
                                <label for="text">Label Alamat</label>
                            </div>
                            <div class="form-floating mb-2 mx-auto">
                                <input type="text" class="form-control" id="nama" name="nama" placeholder="Nama Pengguna" value="<?php echo $row['nama']; ?>" required>
                                <label for="text">Nama Pengguna</label>
                            </div>
                            <div class="form-floating mb-2 mx-auto">
                                <input type="text" class="form-control" id="telepon" name="telepon" placeholder="No. Telepon" value="<?php echo $row['telepon']; ?>" required>
                                <label for="text">No. Telepon</label>
                            </div>
                            <div class="form-floating mb-2 mx-auto">
                                <input type="text" class="form-control" id="alamat" name="alamat" placeholder="Alamat Rumah" value="<?php echo $row['alamat']; ?>" required autofocus>
                                <label for="text">Alamat Rumah</label>
                            </div>
                            <input type="checkbox">&nbspJadikan alamat utama</input>
                        </div>

                        <div class="modal-footer" style="text-align:center;">
                            <input type="hidden" class="btn btn-danger my-3 mx-auto" name="submit" value="Ubah Alamat" style="width:80%;" />
                        </div>
                    </form>
                </div>
            </div>

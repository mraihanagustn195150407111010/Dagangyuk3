...
<body class="mx-2 my-2">
        ...
        <nav class="container-xxl flex-wrap flex-md-nowrap" aria-label="Main navigation">
            ...
            <div class="navbar-collapse collapse" id="bdNavbar">
                <ul class="navbar-nav flex-row flex-wrap ms-md-auto justify-content-center">
                    ...
                    <li><a class="Foto" href="" id="foto" role="foto" data-bs-toggle="fotodrop" aria-expanded="false" title="">
                            <img src="Uploads/<?= $data['foto']; ?>" alt="" width='20' height='20' />
                        </a>
                    </li>
                    ...
                    <li class="nav-item col-3 col-md-auto mx-1 text-center dropdown">
                        <!-- NAMA --> <a class="nav-link" href="PHP" title="Akun"><?= $data['username']; ?></a>
                    </li>
                    <li class="nav-item col-11 col-md-auto mx-1 d-block d-md-none">
                        <hr class="text-white">
                    </li>
                    <li class="nav-item col-3 col-md-auto mx-1 text-end">
                        <a class="nav-link" href="Notifikasi" title="Notifikasi"><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="white" class="bi bi-bell-fill" viewBox="0 0 16 16">
                                <path d="M8 16a2 2 0 0 0 2-2H6a2 2 0 0 0 2 2zm.995-14.901a1 1 0 1 0-1.99 0A5.002 5.002 0 0 0 3 6c0 1.098-.5 6-2 7h14c-1.5-1-2-5.902-2-7 0-2.42-1.72-4.44-4.005-4.901z" />
                            </svg>
                        </a>
                    </li>
                    <li class="nav-item col-1 col-md-auto mx-1 text-center dropdown">
                        <a class="nav-link" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false" title="Akun"><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="white" class="bi bi-person-circle" viewBox="0 0 16 16">
                                <path d="M11 6a3 3 0 1 1-6 0 3 3 0 0 1 6 0z" />
                                <path fill-rule="evenodd" d="M0 8a8 8 0 1 1 16 0A8 8 0 0 1 0 8zm8-7a7 7 0 0 0-5.468 11.37C3.242 11.226 4.805 10 8 10s4.757 1.225 5.468 2.37A7 7 0 0 0 8 1z" />
                            </svg>
                        </a>
                        <ul class="dropdown-menu dropdown-menu-dark" aria-labelledby="navbarDropdown">
                            <li><a class="dropdown-item" href="#" data-toggle="modal" data-target="#edit_data_Modal">Edit</a></li>
                            <li><a class="dropdown-item" href="#" data-toggle="modal" data-target="#adress_Modal">Alamat</a></li>
                            <li>
    ...
    <div style="z-index: 9999;" class="modal fade" id="edit_data_Modal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form class="form-signin" method="post" action="Edit" enctype="multipart/form-data">
                    <div class="modal-body justify-content-center" style="text-align: center;">
                        ...
                        <div class="form-floating mb-2 mx-auto">
                            <input type="Username" class="form-control" id="username" name="username" value="<?= $data['username']; ?>" required>
    ...
    <!-- Adress -->
    <div style="z-index: 9999;" class="modal fade" id="adress_Modal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <form class="form-signup" method="post" action="adress">
                    <div class="modal-body justify-content-center" style="text-align: center;">
                        <div class="form-floating mb-2 mx-auto">
                            <input type="hidden" class="form-control" id="id" name="id" value="<?= $data['id']; ?>" required autofocus>
                            <label for="id">ID</label>
                        ...
                        <div class="form-floating mb-2 mx-auto">
                            <input type="text" class="form-control" id="provinsi" name="provinsi" value="<?= $data['Provinsi']; ?>" required autofocus>
                            <label for="provinsi">Provinsi</label>
                        </div>
                        <div class="form-floating mb-2 mx-auto">
                            <input type="text" class="form-control" id="city" name="city" value="<?= $data['Kabupaten']; ?>" required autofocus>
                        ...
                        <div class="form-floating mb-2 mx-auto">
                            <input type="text" class="form-control" id="vil" name="vil" value="<?= $data['Desa']; ?>" required>
                            <label for="vil">Desa</label>
                        </div>
                        <div class="form-floating mb-2 mx-auto">
                            <input type="text" class="form-control" id="street" name="street" value="<?= $data['Street']; ?>" required>
                            <label for="street">Alamat</label>
                        </div>
                        <div class="form-floating mb-2 mx-auto">
                            <input type="text" class="form-control" id="code" name="code" value="<?= $data['postcode']; ?>" required>
                            <label for="code">Kode Pos</label>
                        </div>
                        <input type="submit" class="btn btn-danger my-3 mx-auto" name="submit" value="Edit Alamat" style="width:80%;" />
                    </div>
                </form>
            </div>
        </div>
            ...
            <div class="row row-cols-1 row-cols-md-3 g-4 mx-2 my-2 justify-content-center" id="kategori">
                ...
                <div class="col mb-3">
                    <div class="card h-100 shadow">
                        <a href="barangcheckout" class="link">
